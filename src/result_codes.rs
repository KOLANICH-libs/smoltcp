...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            Error::OK => write!(f, "The operation has succeed"),
            ...
            Error::InvalidState => write!(f, "The state transition is invalid"),
            Error::BufferFull => write!(f, "The buffer is full"),
            Error::NoFreeSlot => write!(f, "There is no free slot"),
            Error::InvalidName => write!(f, "The name is invalid"),
            Error::NameTooLong => write!(f, "The name is too long"),
            Error::Pending => write!(f, "The operation is not done yet."),
            Error::Failed => write!(f, "The operation has failed"),
